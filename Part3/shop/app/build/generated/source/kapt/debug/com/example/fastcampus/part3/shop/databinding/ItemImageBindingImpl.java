...
public class ItemImageBindingImpl extends ItemImageBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.example.fastcampus.part3.shop.model.Image) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.example.fastcampus.part3.shop.model.Image Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.fastcampus.part3.shop.model.Image item = mItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.example.fastcampus.part3.shop.BindingAdapterKt.setImage(this.mboundView0, itemImageUrl);
        }
    }
