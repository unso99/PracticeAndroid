...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateEquationTextView(){
        val firstFormatedNumber = if (firstNumberText.isNotEmpty())decimalFormat.format(firstNumberText.toString().toBigDecimal()) else ""
        val secondFromatedNumber = if (secondNumberText.isNotEmpty()) decimalFormat.format(secondNumberText.toString().toBigDecimal()) else ""
        binding.equationTextView.text = "$firstFormatedNumber $operatorText $secondFromatedNumber"
    }
}