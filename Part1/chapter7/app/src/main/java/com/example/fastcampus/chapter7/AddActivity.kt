package com.example.fastcampus.chapter7
...
import com.example.fastcampus.chapter7.databinding.ActivityAddBinding
...
class AddActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        originWord = intent.getParcelableExtra("originData")
        originWord?.let { word ->
